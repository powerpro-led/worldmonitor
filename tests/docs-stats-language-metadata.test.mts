...
function buildHtml({ xdefault, locales, jsonld } = {}) {
  const parts = [];
  if (xdefault !== null) {
    parts.push(xdefault ?? '<link rel="alternate" hreflang="x-default" href="https://www.example.test/dashboard" />');
  }
  parts.push(...(locales ?? [
    '<link rel="alternate" hreflang="en" href="https://www.example.test/dashboard?lang=en" />',
    '<link rel="alternate" hreflang="fa" href="https://www.example.test/dashboard?lang=fa" />',
    '<link rel="alternate" hreflang="fr" href="https://www.example.test/dashboard?lang=fr" />',
  ]));
...
describe('validateIndexLanguageMetadata', () => {
  ...
  it('flags an x-default href that carries a ?lang param', () => {
    const failures = validateIndexLanguageMetadata(STATS, buildHtml({
      xdefault: '<link rel="alternate" hreflang="x-default" href="https://www.example.test/dashboard?lang=en" />',
    }));
  ...
  it('flags an hreflang href whose ?lang does not equal its code', () => {
    const failures = validateIndexLanguageMetadata(STATS, buildHtml({
      locales: [
        '<link rel="alternate" hreflang="en" href="https://www.example.test/dashboard?lang=en" />',
        '<link rel="alternate" hreflang="fa" href="https://www.example.test/dashboard?lang=xx" />',
        '<link rel="alternate" hreflang="fr" href="https://www.example.test/dashboard?lang=fr" />',
      ],
    }));
