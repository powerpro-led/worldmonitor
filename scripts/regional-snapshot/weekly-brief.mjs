...
const DEFAULT_PROVIDERS = [
  ...
  },
  {
    ...
    // spending BRIEF_MAX_TOKENS entirely on hidden reasoning and returning
    // empty content (same failure mode as #4983's OpenRouter fix above,
    // Groq's own param name/floor since it has no hard "off").
