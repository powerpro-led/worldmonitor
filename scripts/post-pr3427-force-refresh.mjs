...
console.log('  API_BASE_URL=https://api.example.com WORLDMONITOR_SEED_REFRESH_KEY=<seed-refresh-key> WORLDMONITOR_API_KEY=<read-key> node scripts/seed-resilience-scores.mjs');
