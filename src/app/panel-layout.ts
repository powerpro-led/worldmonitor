...
import { APP_ORIGIN, getVariantOrigin, getSubdomainOrigin } from '@/config/domain';
  ...
  async renderLayout(): Promise<void> {
    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header">
        ...
        return `
            <a href="${vHref('full', `${APP_ORIGIN}/dashboard`)}"
            ...
            <a href="${vHref('tech', getVariantOrigin('tech'))}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('finance', getVariantOrigin('finance'))}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('commodity', getVariantOrigin('commodity'))}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('energy', getVariantOrigin('energy'))}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('happy', getVariantOrigin('happy'))}"
          ...
          <a href="https://github.com/powerpro-led/worldmonitor" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
